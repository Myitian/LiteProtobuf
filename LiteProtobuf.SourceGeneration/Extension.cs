...
static class Extension
{
    ...
    public static void WriteCSharpHeader(this IndentedTextWriter writer, string? extra = null)
    {
    ...
    public static void BeginCSharpTypeBlock(this IndentedTextWriter writer, INamedTypeSymbol type)
    {
    ...
    public static void EndCSharpTypeBlock(this IndentedTextWriter writer)
    {
        while (writer.Indent > 0)
            writer.EndCodeBlock();
    }
    public static void WriteCSharpTypeDef(this IndentedTextWriter writer, INamedTypeSymbol type)
    {
    ...
    public static CSharpTypeBlock CSharpTypeBlock(this IndentedTextWriter writer, INamedTypeSymbol type)
    {
