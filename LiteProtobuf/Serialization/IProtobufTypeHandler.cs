...
public interface IStructProtobufTypeReadOnlyHandler<T>
    where T : allows ref struct
{
    public static abstract bool IsFieldInfoValidForInstance(scoped in T value, FieldInfo fieldInfo, SerializationOptions? options);
...
public interface IStructProtobufTypeWriteOnlyHandler<T>
    where T : allows ref struct
{
...
public interface IStructProtobufTypeHandler<T>
    : IProtobufTypeFactory<T>, IStructProtobufTypeReadOnlyHandler<T>, IStructProtobufTypeWriteOnlyHandler<T>
    where T : allows ref struct;

public interface IClassProtobufTypeReadOnlyHandler<in T>
    where T : class
{
    public static abstract bool IsFieldInfoValidForInstance(T value, FieldInfo fieldInfo, SerializationOptions? options);
...
public interface IClassProtobufTypeWriteOnlyHandler<in T>
    where T : class
{
...
public interface IClassProtobufTypeHandler<T>
    : IProtobufTypeFactory<T>, IClassProtobufTypeReadOnlyHandler<T>, IClassProtobufTypeWriteOnlyHandler<T>
    where T : class;