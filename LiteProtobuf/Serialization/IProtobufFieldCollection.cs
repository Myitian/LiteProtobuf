...
{
    void ReadProtobufBody<TReader>(scoped ref TReader subReader, SerializationOptions? options)
        where TReader : struct, IStructBinaryReader<TReader>, allows ref struct;
    void ReadProtobufBody<TReader>(TReader subReader, SerializationOptions? options)
        where TReader : class, IClassBinaryReader<TReader>;
    bool TryReadProtobufBody<TReader>(scoped ref TReader reader, SerializationOptions? options, out ParseStatus status)
        where TReader : struct, IStructBinaryReader<TReader>, allows ref struct;
    bool TryReadProtobufBody<TReader>(TReader reader, SerializationOptions? options, out ParseStatus status)
        where TReader : class, IClassBinaryReader<TReader>;
    ...
    bool TryAddProtobufField<TReader>(TReader reader, FieldInfo fieldInfo, SerializationOptions? options, out ParseStatus status)
        where TReader : class, IClassBinaryReader<TReader>;
    void WriteProtobufBody<TWriter>(scoped ref TWriter writer, SerializationOptions? options)
        where TWriter : struct, IStructBinaryWriter<TWriter>, allows ref struct;
    void WriteProtobufBody<TWriter>(TWriter writer, SerializationOptions? options)
