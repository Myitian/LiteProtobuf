    ...
    : IClassProtobufTypeHandler<List<T>>
{
    ...
    public abstract bool TryReadProtobuf<TReader>(List<T> self, ref TReader reader, FieldInfo fieldInfo, SerializationOptions? options, out ParseStatus status)
        where TReader : struct, IStructBinaryReader<TReader>, allows ref struct;
    public abstract bool TryReadProtobuf<TReader>(List<T> self, TReader reader, FieldInfo fieldInfo, SerializationOptions? options, out ParseStatus status)
         where TReader : class, IClassBinaryReader<TReader>;
    public abstract void ReadProtobuf<TReader>(List<T> self, ref TReader reader, FieldInfo fieldInfo, SerializationOptions? options)
        where TReader : struct, IStructBinaryReader<TReader>, allows ref struct;
    public abstract void ReadProtobuf<TReader>(List<T> self, TReader reader, FieldInfo fieldInfo, SerializationOptions? options)
         where TReader : class, IClassBinaryReader<TReader>;
    public abstract void WriteProtobuf<TWriter>(List<T> self, ref TWriter writer, FieldInfo fieldInfo, SerializationOptions? options)
    ...
    where T : IProtobufType<T>
{
    ...
    public override bool TryReadProtobuf<TReader>(List<T> self, ref TReader reader, FieldInfo fieldInfo, SerializationOptions? options, out ParseStatus status)
    {
    ...
    public override void ReadProtobuf<TReader>(List<T> self, ref TReader reader, FieldInfo fieldInfo, SerializationOptions? options)
    {
    ...
    public override void WriteProtobuf<TWriter>(List<T> self, ref TWriter writer, FieldInfo fieldInfo, SerializationOptions? options)
    {
    ...
    : GenericListConverter<bool>
{
    ...
    public override bool TryReadProtobuf<TReader>(List<bool> self, ref TReader reader, FieldInfo fieldInfo, SerializationOptions? options, out ParseStatus status)
    {
    ...
    public override void ReadProtobuf<TReader>(List<bool> self, ref TReader reader, FieldInfo fieldInfo, SerializationOptions? options)
    {
    ...
    public override void WriteProtobuf<TWriter>(List<bool> self, ref TWriter writer, FieldInfo fieldInfo, SerializationOptions? options)
    {
